...
const ClaseModal = ({ formData, setFormData, instructores }) => {
  return (
    <>
      ...
      <div className="form-group">
        ...
        <input type="number" value={formData.duracionMinutos || ''} 
          onChange={(e) => setFormData({...formData, duracionMinutos: parseInt(e.target.value) || null})} />
      </div>
    </>
  );
};
