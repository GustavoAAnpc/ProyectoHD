...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Migración automática: Actualizar promociones existentes sin duracionMeses
        promocionRepository.findAll().forEach(promocion -> {
            if (promocion.getDuracionMeses() == null) {
                promocion.setDuracionMeses(1);
                promocionRepository.save(promocion);
            }
        });

        // Datos de prueba deshabilitados - solo se crean si no hay usuarios en la base
        // de datos
         ...
         * Rol entrenadorRol =
         * rolRepository.findByNombreRol(Rol.NombreRol.Entrenador).orElseThrow();
         * 
         ...
         * Rol usuarioRol =
         * rolRepository.findByNombreRol(Rol.NombreRol.Usuario).orElseThrow();
         * 
